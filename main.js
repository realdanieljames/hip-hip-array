...
const removeFirst = symmetricalCapitals.shift()
const removeLast = symmetricalCapitals.pop()
...
const newStartValue = fibonacciNumbers.unshift(0);
const newEndValues = fibonacciNumbers.push(21, 34)
...
const FiveValues = []
let plus3 = FiveValues.push(5,6,7)
let plus2 = FiveValues.unshift(8,9)
for(i in FiveValues){
  console.log(FiveValues[i])
}
...
const array3 = primaries.concat(secondaries);
for( i in array3){
